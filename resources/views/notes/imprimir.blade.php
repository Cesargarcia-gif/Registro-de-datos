...
<body onload="window.print()">
    ...
    <div class="recibo no-break" data-watermark="ORIGINAL">
        ...
        <div class="detalle"><strong>Nombre:</strong> {{ $nota->title }}</div>
        <div class="detalle"><strong>Monto:</strong> {{ $nota->monto }}</div>
        <div class="detalle"><strong>Turno:</strong> {{ $nota->turno }}</div>
        <div class="detalle"><strong>Descripción:</strong> {{ $nota->description }}</div>
    ...
    <div class="recibo no-break" data-watermark="COPIA">
        ...
        <div class="detalle"><strong>Nombre:</strong> {{ $nota->title }}</div>
        <div class="detalle"><strong>Descripción:</strong> {{ $nota->monto }}</div>
        <div class="detalle"><strong>Turno:</strong> {{ $nota->turno }}</div>
        <div class="detalle"><strong>Descripción:</strong> {{ $nota->description }}</div>
